...
const AuthForm = ({ type }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error("Auth Error:", error?.response?.data); // Debugging info
            toast.error(typeof errMsg === "string" ? errMsg : "Something went wrong!");
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 to-purple-800 text-white">
            <div className="bg-white text-gray-900 p-8 rounded-lg shadow-white shadow-2xl w-full max-w-md m-2">
                <h2 className="text-3xl font-extrabold text-center mb-6">
                    {type === 'signup' ? 'SignUp VidApp Calls' : 'Login VidApp Calls'}
                </h2>
